...
bcr <- read_sf(file.path("G:/Shared drives/BAM_NationalModels/NationalModels5.0/Regions/BAM_BCR_NationalModel.shp")) %>% 
...
```{r}
#root<- "C:/Users/Angie/OneDrive - Université Laval/Regional_models"
root<-"C:/Users/ANMOD4/OneDrive - Université Laval/Regional_models"
...
```{r}
save(bcr.StudyArea, StudyAreaFused, file=paste0(root, "/Analisis_RM/StudyArea/StudyArea", ".Rdata"))
```